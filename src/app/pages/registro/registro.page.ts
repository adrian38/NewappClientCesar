...
export class RegistroPage implements OnInit {
 ...
 avatarusuario64:string="";
    ...
    const alert = await this.alertController.create({
      ...
      buttons: [
        
        {
          ...
          text: 'Galeria',
          handler:async  () => {
            let photos: Photo = await this.photoService.addNewToCamara();
            console.log( "Foto",photos.webviewPath);
            if(photos){
              this.avatarusuario= photos.webviewPath;
              console.log(this.avatarusuario);
              this.avatarusuario64= this.photoService.devuelve64(); 
        ...
        },
        {
          ...
          /*   this.verFoto=false;
            ...
            this.avatarusuario = '../../../assets/icon/noImage.svg';
  ...
  iniciar(){
    ...
    console.log("factual", this.fechactual);
    this.fecha=this.fecha.slice(0,4);
    console.log("fechanacimiento", this.fecha);
    let fechavalida=Number(this.fechactual) - Number(this.fecha);
